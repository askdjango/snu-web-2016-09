...
for name in result:
    print('[{}의 평균점수:{}] 국어: {}, 영어: {}, 수학: {}'.format(
        name,
        (int(result[name]['ko_score'])+int(result[name]['en_score'])+int(result[name]['math_score']))/len(result),
...
print('전체 국어 평균점수는?',total_ko_score/len(result))  # TODO: 계산하세요.
print('전체 영어 평균점수는?',total_en_score/len(result))  # TODO: 계산하세요.
print('전체 수학 평균점수는?',total_math_score/len(result))  # TODO: 계산하세요.