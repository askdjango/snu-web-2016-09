...
for name in result:
    ...
    ko_sum+=scores['ko_score']
    en_sum+=scores['en_score']
    math_sum+=scores['math_score']


print('전체 국어 평균점수는 {}입니다.'.format(ko_sum/3))
print('전체 영어 평균점수는 {}입니다.'.format(en_sum/3))
print('전체 수학 평균점수는 {}입니다.'.format(math_sum/3)) 
