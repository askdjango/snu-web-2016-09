...
result = {}
student_num = int(input("계산할 학생 수를 입력하세요 : "))
while student_num<1:
    student_num = int(input("1 이상의 유효한 학생 수를 입력해주세요 : "))
...
for name in result:
    ...
    print('[{}] 평균점수 : {:.2f}점, 국어: {}점, 영어: {}점, 수학: {}점'.format(
        name, dic['average'], dic['ko_score'], dic['en_score'], dic['math_score']
        ))
